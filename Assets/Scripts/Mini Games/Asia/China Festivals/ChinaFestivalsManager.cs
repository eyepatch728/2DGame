...
//public class ChinaFestivalsManager : MonoBehaviour
//{

//    public static ChinaFestivalsManager Instance { get; private set; }
...
//    public float typewriterSpeed = 0.07f;  // Time between each character
...
//    {
//        gameActive = false;
//        ChinaFestivalPopups.Instance.ShowEndGamePopup();
//    }
...
public class ChinaFestivalsManager : MonoBehaviour
{
    ...
    bool isLastItemm = false;
    public void ShowItemPopup(FestivalItem item, bool isLastItem)
    {
        if (item.hasTriggeredPopup) return;
