...
public class AustralianNationalManager : MonoBehaviour
{
    public static AustralianNationalManager Instance;
    ...
    {
        gameActive = false;
        AustralianBotanicGardenPopups.Instance.ShowEndGamePopup();
    }
