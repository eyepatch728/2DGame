...
public class AustralianBotanicGardenPopups : MonoBehaviour
{
    public static AustralianBotanicGardenPopups Instance;
    ...
    IEnumerator CloseTutorialAfterDelay(float delay)
    {
        ...
        if (tutorialPanel.activeSelf)
        {
            ...
            AustralianNationalManager.Instance.StartGame();
        }
    }
